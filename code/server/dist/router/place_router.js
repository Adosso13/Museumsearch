...
class PlaceRouter {
    ...
    getRoutesList = () => {
        ...
        new MyPicsPlacesMiddleware().process, new PlaceController().insert);
        this.router.put("/", this.upload.any(), new MyPicsPlacesMiddleware().process, new PlaceController().update);
        this.router.delete("/", this.upload.any(), new MyPicsPlacesMiddleware().process, new PlaceController().delete);
        return this.router;
    };
}
