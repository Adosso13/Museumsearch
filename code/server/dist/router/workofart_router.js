...
class WorkOfArtRouter {
    ...
    getRoutesList = () => {
        ...
        new MyPicsWorksMiddleware().process, new WorkOfArtController().insert);
        this.router.put("/", this.upload.any(), new MyPicsWorksMiddleware().process, new WorkOfArtController().update);
        this.router.delete("/", this.upload.any(), new MyPicsWorksMiddleware().process, new WorkOfArtController().delete);
        return this.router;
    };
}
